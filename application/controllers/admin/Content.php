...
class Content extends CI_Controller {
	...
	public function insert(){
		...
		$this->form_validation->set_rules('name', 'Title', 'required|is_unique[db_content.title]');
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_flashdata('success', 'Add blog successfully');
	...
	public function update($id){
		...
		if ($this->form_validation->run() == TRUE) 
		{
			...
			$this->session->set_flashdata('success', 'Update blog successfully');
			redirect('admin/content/','refresh');
		} 
	...
	public function trash($id){
		...
		$this->Mcontent->content_update($mydata, $id);
		$this->session->set_flashdata('success', 'Deleted post to trash successfully');
		redirect('admin/content','refresh');
	}
	...
	public function restore($id){
		...
		$this->session->set_flashdata('success', 'Blog recovery successful');
