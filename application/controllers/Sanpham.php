...
class Sanpham extends CI_Controller {
    ...
    public function index(){
        ...
        $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='Store');
        $this->data['list']=$this->Mproduct->product_sanpham($limit,$first,$f,$od);
        $this->data['title']='Anipat - Store';
    ...
    public function category(){
        ...
        $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='Store/'.$link);
        $this->data['list']=$this->Mproduct->product_list_cat_limit($listcat, $limit,$first,$f,$od);
        $this->data['title']='Anipat - Products by category';  
...
//day r ok 
    ...
    public function detail($link){   
        ...
        $this->data['row']=$row;
        $this->data['title']='Anipat - '.$row['name'];  
