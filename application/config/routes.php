...
$route['Blog'] = 'tintuc/index';
$route['Service'] = 'dichvu/index';
$route['Store/(:num)'] = 'sanpham/index/$1';
$route['Store/(:any)'] = 'sanpham/category';
$route['Store/(:any)/(:num)'] = 'sanpham/category/$1';

$route['Blog/(:num)'] = 'tintuc/index/$1';
$route['Blog/(:any)'] = 'tintuc/detail';
$route['Service/(:num)'] = 'dichvu/index/$1';
$route['Service/(:any)'] = 'dichvu/detail';

$route['Contact'] = 'lienhe/index';
$route['tim-kiem'] = 'timkiem';
$route['Store'] = 'sanpham/index';
$route['Store/(:num)'] = 'sanpham/index/$1';
$route['Store/(:any)'] = 'sanpham/category';
$route['Store/(:any)/(:num)'] = 'sanpham/category/$1';
$route['Login'] = 'dangnhap/dangnhap';
$route['quen-mat-khau'] = 'dangnhap/forget_password';
$route['Register'] = 'dangnhap/dangky';
$route['dang-xuat'] = 'dangnhap/dangxuat';
$route['Cart'] = 'giohang/index';
$route['checkout'] = 'giohang/checkout';
$route['info-order'] = 'giohang/info_order';
$route['thankyou'] = 'giohang/thankyou';
$route['Profile'] = 'thongtin/index';
$route['search?(:any)'] = 'search/index/$1';
$route['search?(:any)/(:num)'] = 'search/index/$1';
$route['About'] = 'gioithieu/index';
...
$route['service/status/(:num)'] ='service/status/$1';
$route['service/insert'] ='service/insert';
$route['service/recyclebin'] ='service/recyclebin';
$route['service/recyclebin/(:num)'] ='service/recyclebin/$1';
$route['service/trash/(:num)'] ='service/trash/$1';
$route['service/delete/(:num)'] ='service/delete/$1';
$route['service/restore/(:num)'] ='service/restore/$1';
