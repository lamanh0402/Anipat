...
class Phantrang{
	...
	function PagePer($total, $current, $limit, $url='')
	{
		...
		if( $current == 1)
		{
			$html.= "<li class = 'hidden-xs'><a style='font-size:10px'>First</a></li>";
			$html.= "<li><a><</a></li>";
		}
		else
		{
			$html.= "<li class = 'hidden-xs'><a href='$url/1' style='font-size:10px'>First</a></li>";
		...
		if($current <= 3)
		{
			for($i = 1; ($i <= 5) && ($i <= $numPage); $i++)
			{
				if($i == $current)
				{
					$html.= "<li class = 'pagination_three'><a>".$i."</a></li>";
				}
				else
				{
		...
		{
			$html.= "<li><a>></a></li>";
			$html.= "<li class = 'hidden-xs'><a style='font-size:10px'>Last</a></li>";
		}
		else
		{
			$html.="<li><a href='$url/".($current + 1)."'>></a></li>";
			$html.="<li class = 'hidden-xs'><a href='$url/$numPage' style='font-size:10px'>Last</a></li>";
		}
		return $html;
	}
}
