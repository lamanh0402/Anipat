...
<div class="breadcrumb_container"
	style="background-image: url(<?php echo base_url() ?>/public/uploads/banner/<?php echo $value['img'] ?>); height: 450px; width:100%">
</div>
<?php endforeach; ?>
<!-- end_bannershop -->
...
">
<?php echo $categoryname ?></h4>					<div class="Relevance">
						<span>Sort by:</span>
										...
										<div class="single_product__inner">
											...
											<a href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>" >
                                                ...
                                                <?php if($sp['sale'] > 0) :?>
													...
													style="font-size:14px;background:red">-<?php echo $sp['sale'] ?>%</span>
                                                <?php endif; ?>
											</div>
											<div class="product__content text-center">
												<div class="produc_desc_info">
													<div class="product_title"
														style="max-height: 37px; overflow:hidden; padding: 0px 10px;">
														<h3>
                                                        <a href="<?php echo $sp['alias'] ?>" title="<?php echo $sp['name'] ?>">
                                                    <?php echo $sp['name'] ?>
                                                </a>
