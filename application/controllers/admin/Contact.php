...
class Contact extends CI_Controller {
	...
	public function index(){
		...
		$this->data['title']='Customer Contact List
		';
	...
	public function detail($id){
		...
		$this->data['title']='Customer Contact Detail
		';
		$this->load->view('backend/layout', $this->data);
    }
	...
	public function trash($id){
		...
		$this->Mcontact->contact_update($mydata,$id);
		$this->session->set_flashdata('success', 'Deleted to trash successfully');
		redirect('admin/contact','refresh');
	}
	...
	public function restore($id){
		...
		$this->session->set_flashdata('success', 'Successful recovery');
		redirect('admin/contact/recyclebin','refresh');
	}
